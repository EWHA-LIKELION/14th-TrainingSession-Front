...
interface CommentSectionProps {
  comments?: Comment[]; // Comment 배열이 들어올 수 있음, 없을 수도 있음
}
      ...
      <ul className="flex flex-col -mt-2">
        ...
        {comments?.map((comment) => (
          <CommentItem
            ...
            isMyComment={comment.isMyComment as unknown as BooleanConstructor} // Boolean 형식의 인수는 <Post | null> 형식의 매개 변수에 할당될 수 없다고 해서... BooleanConstructor로 변환해야 한다고 하네여
          />
        ))}
      </ul>
    </section>
