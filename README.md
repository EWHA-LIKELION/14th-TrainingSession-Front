...
이론 수업을 들을 때는 다 이해가 되는 것 같더니만, 막상 실습을 시작하니 막히는 곳이 많았습니다. 적응할 때까지는 이번주차 장표를 자주 열어볼 듯합니다. 도움주신 운영진 분들께 감사합니다... (//) 과제를 하면서도 add, push, commit을 계속 반복했습니다. 커밋하고 나면 수정할 사항이 보이고 그러네요. 역시 코딩은 직접 손으로 자주 써보고 시행착오를 겪어야 제 것이 되는 것 같습니다. 세션에서 배운 것을 복습하는 시간보다, 과제의 가독성을 좋게 하기 위해 마크다운 문법을 익히며 시간을 많이 소모했습니다 ㅎ.ㅎ 비주얼 스튜디오 코드와 깃허브가 익숙해질 때까지 파이팅!! 오늘은 프로그램을 다루는 기초만 배웠으나, 시작이 반이라는 말이 있듯이 깃허브에 레포지토리를 만든 흔적이 남으니 뭔가 해낸 것 같아 뿌듯합니다. 앞으로의 교육 세션도 기대됩니다!

궁금한점: commit -m "~~" 명령어를 적으면 정상적으로 커밋이 되는데, 비주얼 스튜디오 코드 내에서 파란색 커밋 버튼을 누르면 에러가 뜨고 커밋이 되지 않습니다. 이런 경우 어떻게 오류를 해결해야 하는지 알고 싶습니다..!