...
const PostArticle = ({ post }) => {
  ...
  return (
    <article className="bg-white w-172 min-h-260 p-7.5 rounded-lg flex flex-col">
      ...
      <section className="mt-8 self-stretch grow text-base font-normal leading-5 text-gray-1">
        {/* content 연결 */}
